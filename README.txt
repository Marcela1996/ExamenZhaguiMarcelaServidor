...
a persistence unit "ExamenZahguiMarcelaPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ExamenZahguiMarcela\pom.xml":
...
artifact ("ExamenZahguiMarcela.war") is already built. You can build
